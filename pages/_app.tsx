...
const MyApp = ({Component, pageProps, session}) => {
   ...
   const {categoryList, eventList} = pageProps;
   ...
   return (
      ...
      <Provider store={store}>
         <Head>
            <title>Book@365</title>
            <meta name='description' content='Generated by create next app' />
            <link rel='icon' href='/favicon.ico' />
         </Head>
         <Script src='https://sp.zalo.me/plugins/sdk.js'></Script>

         <Header categoryList={categoryList} eventList={eventList}></Header>
         <div className=''>
...
MyApp.getInitialProps = async (appContext: AppContext) => {
   let appProps, categoryList, eventList;
   ...
   try {
      ...
      const [categoryRes, eventRes] = await Promise.all([categoryPos, eventPos]);
      ...
      eventList =
         eventRes?.data?.data.length >= 0
            ? eventRes?.data?.data.filter((event) => event.status == true)
            : [];
   } catch (error) {}
